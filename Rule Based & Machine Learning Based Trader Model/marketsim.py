...
def get_portVal(df_orders, start_val = 100000):
...
if __name__ == "__main__":
    of = "orders_RuleBased_aj.csv"
    if os.path.isfile(of) == False:
        print "orders_RuleBased_aj.csv is not found!. Please run rule_based.py file to generate the csv file."
